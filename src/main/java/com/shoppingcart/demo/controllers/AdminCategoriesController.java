...
public class AdminCategoriesController {
    ...
    public String index(Model model) {
        List<Category> categoryies = categoryRepo.findAllByOrderBySortingAsc();
    ...
    @GetMapping("/add")
    public String add(Category category) { // equals model.addAttribute("categories", categoryies); or @ModelAttribute
    ...
    public String edit(@Valid Category category, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        redirectAttributes.addFlashAttribute("message", "Categories edited");
        redirectAttributes.addFlashAttribute("alertClass", "alert-success");
